...
def test_daily_load_sums_project_quotas_and_flags_baseline_and_stretch():
    ...
    a = _project(pid="P-A", contract_start=date(2026, 3, 1), deadline_date=date(2026, 3, 4), planned_fh=4.0)

    # Project B: 2026-03-03 .. 2026-03-06 (4 days), planned 4 FH => quota 1.0/day
    b = _project(pid="P-B", contract_start=date(2026, 3, 3), deadline_date=date(2026, 3, 6), planned_fh=4.0)
